...
/**
 * SearchBar.jsx
 * - debounced search-as-you-type with light suggestions
 * - "/" focuses input (also handled at App-level)
 * - unchanged: user types stop name and optional comma-separated routes
 */
...
export default function SearchBar({ onSearch }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4 bg-white dark:bg-gray-800 shadow-lg p-4 rounded-xl flex flex-col md:flex-row gap-3 items-center" role="search" aria-label="Search bus stop">
      <div className="relative flex-1 w-full">
        ...
        />
        <Suggestions id="search-suggestions" visible={showSuggestions} items={suggestions} onPick={handleSuggestionPick} />
      </div>
